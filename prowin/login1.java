...
public class login1 extends JFrame implements ActionListener {
	...
	public login1() {
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\91741\\OneDrive\\Pictures\\login1.jpg"));
		lblNewLabel_2.setBounds(0, 0, 668, 496);
		contentPane.add(lblNewLabel_2);
		
		try {
			Class.forName("com.mysql.cj.jdbc.Driver");
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/to do list","root","");
